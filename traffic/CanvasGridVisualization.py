...
class CanvasGridS(VisualizationElement):
    ...
    local_includes = ["CanvasModuleS.js"]
    ...
    def __init__(
        ...
        new_element = "new CanvasModuleS({}, {}, {}, {})".format(
            ...
            for y in range(model.grid.height):
                ...
                for obj in cell_objects:
                    ...
                    if portrayal:
                        # portrayal["x"] = x
                        # portrayal["y"] = y
                        portrayal["x"] = int(portrayal["x"])
                        portrayal["y"] = int(portrayal["y"])
